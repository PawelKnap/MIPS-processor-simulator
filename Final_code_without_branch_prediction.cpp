...
{ 
    ...
    for(;;){    //endless loop
        ...
        if(branch){    //if there should be branch
            PC=branch_addr_MEM;
            stall=false;
            //cout<<"BRANCH"<<endl;
        }
        ...
        if(n!=1){
            ...
            if(n>2){
                ...
                if(n>3){
                    ...
                    if(op_code_MEM==4){ //branch signal decides about branching
                        branch=ctr_MEM.Branch && zero_MEM;
                        //cout<<branch<<" EQUAL"<<endl;
                    }
                    ...
                    if(stall_info_MEM){                  //it should be high when control for branching is on and there is correct result in ALU
                        ...
                        if(correct && !branch){ //there should be no jump
